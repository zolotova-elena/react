                ...
                <div className="col">
                    <section>
                        ...
                        <ul className="nav flex-column">
                            <li className="nav-item"><NavLink  to="/about" exact  className="nav-link">О магазине</NavLink ></li>
                            <li className="nav-item"><NavLink  to="/catalog" exact className="nav-link">Каталог</NavLink ></li>
                            <li className="nav-item"><NavLink  to="/contacts" exact className="nav-link">Контакты</NavLink ></li>
                        </ul>
                    </section>
                </div>
                <div className="col">
